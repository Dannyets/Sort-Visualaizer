...
import { InputWrapper, InputRow, RefreshButtonContainer, styles } from './AutoSuggestInput.styles';
            ...
            <InputWrapper>
                <InputRow>
                    ...
                    <RefreshButtonContainer>
                        <IconButton className={classes.refreshButton} onClick={loadSuggestions}>
                            <RefreshIcon/>
                        </IconButton>
                    </RefreshButtonContainer>}
                </InputRow>
